...
class EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_BASE(rfm.RunOnlyRegressionTest):
    """
...
@rfm.simple_test
class EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_1M(EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_BASE, EESSI_Mixin):
    """
...
@rfm.simple_test
class EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_8M(EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_BASE, EESSI_Mixin):
    """
    This is the main OPENFOAM class for the Lid-driven cavity test. The test consists of many steps which are run as
    pre-run commands and the main test with the executable `icoFoam` is measured for performance.
    """
...
@rfm.simple_test
class EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_64M(EESSI_OPENFOAM_ORG_LID_DRIVEN_CAVITY_BASE, EESSI_Mixin):
    """
    This is the main OPENFOAM class for the Lid-driven cavity test. The test consists of many steps which are run as
    pre-run commands and the main test with the executable `icoFoam` is measured for performance.
    """
