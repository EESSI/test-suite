...
class EESSI_Mixin(RegressionMixin):
    ...
    def mixin_validate_item_in_dict(self, item, item_dict, check_keys=False):
        """
    ...
    def mixin_measure_mem_usage(self):
    ...
    @run_after('setup')
    def mixin_log_runtime_info(self):
    ...
    @run_after('run')
    def mixin_extract_runtime_info_from_log(self):
